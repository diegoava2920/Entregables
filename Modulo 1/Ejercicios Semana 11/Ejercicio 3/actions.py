...
def add_student():#funcion para agregar un estudiante
    ...
    while(closure == 0):
        ...
        new_student = Student(name, classroom, spanish_grade, english_grade, history_grade, science_grade)#Creacion de una instancia para un nuevo estudiante
...
def view_students():#funcion para revisar la lista de estudiantes
    for Student in student_list:
        Student.show_student_info()#llamado al metodo para mostrar la informacion de los estudiantes
...
def get_top_3_average():#funcion para revisar los top 3 mejores promedios
    ...
    for Student in top3:
        Student.show_studnet_average()#llamado al metodo para mostrar los promedios de los estudiantes
...
def get_total_average():#funcion para revisar el promedio total de todos los estudnates 
    ...
    for Student in student_list:
        total_average = total_average + Student.get_promedio()#formula para calcular la suma de todos los promedios
